...
from package.idw import holdout_idw
from package.kriging import holdout_kriging
...
rmse_results2 = holdout_kriging(readings, boundary, 100, 10, 0.8)
...
plt.tight_layout()
plt.savefig('images/rmse_comparison_holdout.png')
